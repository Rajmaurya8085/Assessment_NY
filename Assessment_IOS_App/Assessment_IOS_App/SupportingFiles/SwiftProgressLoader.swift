...
public class SwiftLoader: UIView {
    ...
    static public var isShown = false
    ...
    public class func show(title: String?, animated : Bool) {
        ...
        loader.coverView?.backgroundColor = UIColor.gray
        loader.coverView?.alpha = 0.3
        loader.coverView?.tag = coverViewTag
    ...
    public struct Config {
         ...
         */
        public var spinnerColor = UIColor(red: 59.0/255.0, green: 214.0/255.0, blue: 198.0/255.0, alpha: 1.0)
